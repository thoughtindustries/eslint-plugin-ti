...
module.exports.replace = () => ({
  ...
  "r.pool.run(r.table(__a).get(id).update(__b, { returnChanges: 'always' })('changes').nth(0)('new_val'))":
  ...
  'r.pool.run(r.table(tableName).update(__object))': `r[tableName].update(r, __object)`
});
